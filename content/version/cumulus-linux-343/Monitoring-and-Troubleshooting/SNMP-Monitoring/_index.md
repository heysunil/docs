...
When you configure [Management VRF](/display/CL343/Management+VRF), you
...
<td><p>L2 neighbor info from <code>lldpd</code> (note, you need to <a href="/version/cumulus-linux-343/Layer-One-and-Two/Link-Layer-Discovery-Protocol/">enable the SNMP subagent</a> in LLDP). <code>lldpd</code> needs to be started with the <code>-x</code> option to enable connectivity to <code>snmpd</code> (AgentX).</p></td>
</tr>
<tr class="even">
