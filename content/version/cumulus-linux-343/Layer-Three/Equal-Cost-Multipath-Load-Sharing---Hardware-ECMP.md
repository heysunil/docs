...
weight: 189
aliases:
 - /display/CL343/Equal+Cost+Multipath+Load+Sharing+++Hardware+ECMP
...
section](/version/cumulus-linux-343/Layer-Three/Border-Gateway-Protocol-BGP)
...
3.  [Restart](/version/cumulus-linux-343/System-Configuration/Configuring-switchd)
    the `switchd` service:
