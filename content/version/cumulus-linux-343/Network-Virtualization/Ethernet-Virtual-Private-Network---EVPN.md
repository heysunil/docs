...
weight: 149
aliases:
 - /display/CL343/Ethernet+Virtual+Private+Network+++EVPN
...
FRR, refer to the [FRR Overview](/display/CL343/FRRouting+Overview).
...
Replication
(HER)](/version/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/).
HER is enabled by default, as it is when [Lightweight Network
Virtualization
(LNV)](/display/CL343/Lightweight+Network+Virtualization+-+LNV+Overview)
is used.
...
The active-active configuration should include the following:
  ...
  - The `clagd-vxlan-anycast-ip` parameter must be under the [loopback
    stanza](/version/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode)
    on both peers
  ...
  - The
    [VNIs](/version/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode)
    must be configured identically on both peers

  - The
    [peerlink](/version/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode)
