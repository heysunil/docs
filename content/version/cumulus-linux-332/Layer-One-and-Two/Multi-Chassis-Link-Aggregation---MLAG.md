...
MLAG has these requirements:
  ...
  - The dual-connected devices (servers or switches) can use LACP (IEEE
    ...
    [balance-xor
    mode](/version/cumulus-linux-332/Layer-One-and-Two/Bonding-Link-Aggregation)
...
use](/version/cumulus-linux-332/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments).
...
Assurance](/version/cumulus-linux-332/Layer-One-and-Two/Spanning-Tree-and-Rapid-Spanning-Tree).)
